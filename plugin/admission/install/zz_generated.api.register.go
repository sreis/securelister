...
import (
	...
	initializer "github.com/sreis/securelister/plugin/admission"
	. "github.com/sreis/securelister/plugin/admission/workspace"
...
func init() {
	...
	server.AggregatedAdmissionPlugins["Workspace"] = NewWorkspacePlugin()
