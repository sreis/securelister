...
import (
	...
	. "github.com/sreis/securelister/pkg/apis/workspaces/v1"
	. "github.com/sreis/securelister/pkg/client/clientset_generated/clientset/typed/workspaces/v1"
)

var _ = Describe("Workspace", func() {
	var instance Workspace
	var expected Workspace
	var client WorkspaceInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.WorkspacesV1().Workspaces("workspace-test-valid")
