...
import (
	...
	v1 "github.com/sreis/securelister/pkg/apis/workspaces/v1"
	scheme "github.com/sreis/securelister/pkg/client/clientset_generated/clientset/scheme"
...
type WorkspaceInterface interface {
	...
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Workspace, err error)
	WorkspaceExpansion
}
...
func newWorkspaces(c *WorkspacesV1Client, namespace string) *workspaces {
	return &workspaces{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *workspaces) Get(name string, options metav1.GetOptions) (result *v1.Workspace, err error) {
	result = &v1.Workspace{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("workspaces").
...
func (c *workspaces) List(opts metav1.ListOptions) (result *v1.WorkspaceList, err error) {
...
func (c *workspaces) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *workspaces) Create(workspace *v1.Workspace) (result *v1.Workspace, err error) {
	result = &v1.Workspace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("workspaces").
...
func (c *workspaces) Update(workspace *v1.Workspace) (result *v1.Workspace, err error) {
	result = &v1.Workspace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workspaces").
...
func (c *workspaces) UpdateStatus(workspace *v1.Workspace) (result *v1.Workspace, err error) {
	result = &v1.Workspace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workspaces").
...
func (c *workspaces) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *workspaces) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *workspaces) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Workspace, err error) {
	result = &v1.Workspace{}
