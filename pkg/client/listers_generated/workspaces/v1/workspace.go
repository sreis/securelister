...
type WorkspaceLister interface {
	...
	List(selector labels.Selector) (ret []*v1.Workspace, err error)
...
// List lists all Workspaces in the indexer.
func (s *workspaceLister) List(selector labels.Selector) (ret []*v1.Workspace, err error) {
...
// List lists all Workspaces in the indexer for a given namespace.
func (s workspaceNamespaceLister) List(selector labels.Selector) (ret []*v1.Workspace, err error) {
...
// Get retrieves the Workspace from the indexer for a given namespace and name.
func (s workspaceNamespaceLister) Get(name string) (*v1.Workspace, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("workspace"), name)
	}
